...
type ProjectServiceClient interface {
	...
	UpdateDeleteProject(ctx context.Context, in *ProjectRpcMessage, opts ...grpc.CallOption) (*DeleteProjectResponse, error)
...
func (c *projectServiceClient) UpdateDeleteProject(ctx context.Context, in *ProjectRpcMessage, opts ...grpc.CallOption) (*DeleteProjectResponse, error) {
	out := new(DeleteProjectResponse)
	err := c.cc.Invoke(ctx, "/project.service.v1.ProjectService/UpdateDeleteProject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProjectServiceServer interface {
	...
	UpdateDeleteProject(context.Context, *ProjectRpcMessage) (*DeleteProjectResponse, error)
...
func (UnimplementedProjectServiceServer) UpdateDeleteProject(context.Context, *ProjectRpcMessage) (*DeleteProjectResponse, error) {
...
func _ProjectService_UpdateDeleteProject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/project.service.v1.ProjectService/UpdateDeleteProject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
