...
type ProjectRepo interface {
	...
	FindCollectByMemId(ctx context.Context, memberId int64, page int64, size int64) ([]*data.ProjectAndMember, int64, error)
	...
	DeleteProjectCollection(ctx context.Context, memId int64, projectCode int64) error
	...
	FindProjectById(ctx context.Context, projectCode int64) (pr *data.Project, err error)
